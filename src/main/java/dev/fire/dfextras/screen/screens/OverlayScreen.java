package dev.fire.dfextras.screen.screens;

import com.google.common.collect.Lists;
import com.mojang.blaze3d.systems.RenderSystem;
import dev.fire.dfextras.Mod;
import dev.fire.dfextras.config.overlayScreen.OverlayConfig;
import dev.fire.dfextras.devutils.InputUtils;
import dev.fire.dfextras.screen.utils.Point2d;
...
public class OverlayScreen extends Screen {
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (RenderObject object : Mod.OVERLAY_MANAGER.getRenderList()) {
    ...
    public static boolean isOverlayScreenOpen() {
        return Mod.MC.currentScreen instanceof OverlayScreen;
    }
}