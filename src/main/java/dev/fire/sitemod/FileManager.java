...
public class FileManager {
    ...
    public static Path Path() {
        Path path = SiteMod.MC.runDirectory.toPath().resolve(SiteMod.MOD_ID);
        path.toFile().mkdir();
        return path;
    }
    ...
    public static File getConfigFile() {
        return new File(FabricLoader.getInstance().getConfigDir().toFile(), SiteMod.MOD_ID + "_config.json");
    }

    public static File getOverlayConfigFile() {
        return new File(FabricLoader.getInstance().getConfigDir().toFile(), SiteMod.MOD_ID + "_overlay_config.json");
    }
